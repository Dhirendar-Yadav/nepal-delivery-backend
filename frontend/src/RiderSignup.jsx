...
function RiderSignup() {
  ...
  const handleRiderSignup = async (e) => {
    ...
    if (isCompressing)
      return alert(
        "Hajur, documents optimize hudai chha. Kripya ekxin parkhinu...",
      );

    const nepalPhoneRegex = /^(97|98)\d{8}$/;
    if (!nepalPhoneRegex.test(formData.phone)) {
      alert(
        "Kripya sahi Nepal mobile number halnuhos (98/97 bata suru hune 10 digits).",
      );
      return;
    }
    ...
    data.append(
      "bikeNumber",
      `${bikeParts.zone} ${bikeParts.lot} ${bikeParts.cat} ${bikeParts.num}`,
    );
        ...
        <div className="w-full max-w-4xl flex flex-col">
          <div className="text-center mb-16 mt-16 md:mt-0">
            ...
            <div className="flex items-center justify-center gap-3 mt-4">
              <p className="text-gray-400 text-xs sm:text-sm font-black uppercase tracking-[0.2em]">
                Nepal Secure KYC System
              </p>
              <img
          ...
          <form onSubmit={handleRiderSignup} className="flex flex-col gap-10">
            <div className="space-y-6">
              <h3 className="text-sm font-black text-orange-500 uppercase tracking-widest ml-1">
                Personal Details
              </h3>
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="flex gap-0 shadow-inner rounded-2xl overflow-hidden border-2 border-transparent focus-within:border-orange-500 transition-all">
                  <span className="bg-gray-100 px-6 flex items-center text-base font-black text-gray-400">
                    +977
                  </span>
                  <input
                    type="tel"
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-white p-4 rounded-xl border border-gray-100 text-center shadow-sm">
                      <label className="text-[9px] font-black text-gray-400 uppercase block mb-3 underline decoration-orange-500">
                        Citizenship Front
                      </label>
                      <input
                        type="file"
                        ...
                        onChange={(e) =>
                          handleFileProcessing(e, "citizenshipFront")
                        }
                        required
                      />
                    </div>
                    <div className="bg-white p-4 rounded-xl border border-gray-100 text-center shadow-sm">
                      ...
                      <input
                        ...
                        className="w-full text-[10px] font-bold"
                        onChange={(e) =>
                          handleFileProcessing(e, "citizenshipBack")
                        }
                        required
                      />
                    </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm h-[104px] flex flex-col justify-center">
                    ...
                    <input
                      ...
                      accept="image/*"
                      className="w-full text-[10px] font-bold"
                      onChange={(e) => handleFileProcessing(e, "licenseFront")}
                      required
                    />
                  </div>
                </div>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                <select
                  className="p-5 bg-gray-50 border border-gray-100 rounded-2xl text-sm font-black outline-none appearance-none cursor-pointer"
                  value={bikeParts.zone}
                  onChange={(e) =>
                    setBikeParts({ ...bikeParts, zone: e.target.value })
                  }
                >
                  {zones.map((z) => (
                ...
                <input
                  type="number"
                  placeholder="Lot"
                  className="p-5 bg-gray-50 border border-gray-100 rounded-2xl text-sm font-black outline-none shadow-inner"
                  onChange={(e) =>
                    setBikeParts({ ...bikeParts, lot: e.target.value })
                  }
                  required
                />
                <select
                  ...
                  value={bikeParts.cat}
                  onChange={(e) =>
                    setBikeParts({ ...bikeParts, cat: e.target.value })
                  }
                >
                  {categories.map((c) => (
                ...
                <input
                  ...
                  className="p-5 bg-gray-50 border border-gray-100 rounded-2xl text-sm font-black outline-none shadow-inner"
                  onChange={(e) =>
                    setBikeParts({ ...bikeParts, num: e.target.value })
                  }
                  required
                />
              </div>
              <div className="bg-gray-50 p-6 rounded-[2rem] border-2 border-dashed border-gray-200 text-center">
                <label className="text-[10px] font-black text-gray-400 uppercase block mb-3">
                  Bluebook Front Page Photo
                </label>
                <input
                  type="file"
                  accept="image/*"
                  className="w-full text-xs font-bold max-w-xs mx-auto"
                  onChange={(e) => handleFileProcessing(e, "bluebookImage")}
                  required
                />
              </div>
            </div>
            ...
            <div className="space-y-6 border-t border-gray-100 pt-10">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <input
                  ...
                  className="w-full p-5 bg-gray-50 rounded-2xl border-2 border-transparent focus:border-orange-500 outline-none font-bold text-base shadow-inner"
                  onChange={(e) =>
