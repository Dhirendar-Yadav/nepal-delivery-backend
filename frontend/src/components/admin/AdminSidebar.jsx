    ...
    <aside className="w-full md:w-64 bg-gray-900 border-r border-gray-800 p-6 flex flex-col justify-between shadow-[4px_0_24px_rgba(0,0,0,0.4)] z-20 relative">
      <div>
        ...
        <div
          ...
          className="flex items-center gap-3 mb-10 sidebar-logo cursor-pointer hover:opacity-80 transition-opacity"
        >
          <div className="w-10 h-10 bg-orange-600 rounded-xl flex items-center justify-center font-black text-white text-lg shadow-[0_0_15px_rgba(234,88,12,0.4)]">
            FS
          </div>
          <div>
            <h1 className="text-white font-black tracking-widest text-sm uppercase">
              Food Samundar
            </h1>
          </div>
        </div>
