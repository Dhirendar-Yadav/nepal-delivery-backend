...
function RiderOrdersTab({
    ...
    return (
      <div className="bg-white dark:bg-gray-900 py-16 px-4 rounded-3xl text-center shadow-sm border border-gray-100 dark:border-gray-800">
        ...
        <p className="text-sm text-gray-500 mt-2 font-medium max-w-xs mx-auto">
          Go to the Home tab to accept new deliveries.
        </p>
      </div>
    );
  }
  ...
  const pickupCoords = getSafeCoords(
    activeOrder.restaurantId?.latitude,
    activeOrder.restaurantId?.longitude,
  );
  ...
  const centerPoint =
    deliveryStatus === "pickup" ? pickupCoords : dropoffCoords;
      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl shadow-sm border border-gray-200 dark:border-gray-800 flex flex-col lg:flex-row items-center justify-between p-3 gap-4 transition-all hover:shadow-md">
        ...
        <div className="flex flex-col w-full lg:w-auto">
          <span className="text-[10px] font-bold text-orange-500 uppercase tracking-wider">
            {deliveryStatus === "pickup" ? "Pickup" : "Deliver To"} • #
          ...
          <span className="text-sm font-black text-gray-900 dark:text-white line-clamp-1">
            {deliveryStatus === "pickup"
              ...
              : activeOrder.customerId?.name || "Customer"}
          </span>
        </div>
              ...
              >
                ...
                {deliveryStatus === "dropoff" && (
                  <Marker position={dropoffCoords} icon={dropoffIcon}>
                    <Popup>
                      Dropoff: {activeOrder.deliveryDetails?.address}
                    </Popup>
                  </Marker>
                )}
              </MapContainer>
          ...
          >
            <div className="flex justify-between items-center mb-6">
              ...
              <button
                ...
                className="w-8 h-8 bg-gray-100 dark:bg-gray-800 rounded-full text-gray-500 hover:bg-gray-200 transition-colors font-bold flex items-center justify-center"
              >
                ✕
              </button>
            </div>
            ...
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-6 text-center">
              ...
              <span className="font-bold text-gray-900 dark:text-gray-200">
                {activeOrder.customerId?.name || "the customer"}
              </span>{" "}
              for the 4-digit PIN.
            </p>
