...
function RiderProfileTab({ riderName, riderDetails }) {
  ...
  const submitProfileUpdate = (e) => {
    e.preventDefault();
    if (
      updateForm.phone !== riderDetails.phone ||
      updateForm.email !== riderDetails.email
    ) {
  ...
  const finalizeUpdate = () => {
    setUpdateMessage(
      "✅ Your request has been submitted. Please wait 2-3 hours for Admin verification and approval.",
    );
    setTimeout(() => {
          ...
          <form onSubmit={submitProfileUpdate} className="space-y-4">
            <div className="p-3 bg-blue-50 dark:bg-blue-900/10 rounded-lg border border-blue-200 dark:border-blue-900 mb-4">
              <p className="text-xs text-blue-700 dark:text-blue-400 font-medium">
                Changes to Phone or Email will require OTP verification.
              </p>
            </div>
            <div>
              ...
              <input
                ...
                className="w-full bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white p-3 rounded-xl text-sm outline-none focus:border-orange-500"
                required
              />
            </div>
            <div>
            ...
            <div>
              <label className="block text-xs font-bold text-gray-500 uppercase mb-1">
                Active Vehicle Number
              </label>
              <input
                type="text"
                value={updateForm.bikeNumber}
                onChange={(e) =>
                  setUpdateForm({
                    ...updateForm,
                ...
                className="w-full bg-gray-50 dark:bg-gray-950 border border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white p-3 rounded-xl text-sm outline-none focus:border-orange-500 uppercase font-mono"
                required
              />
            </div>
            <button
              type="submit"
              className="w-full bg-orange-500 text-white font-bold py-3.5 rounded-xl shadow-md hover:bg-orange-600 mt-4"
            >
              Continue
            </button>
          </form>
          ...
          <form onSubmit={verifyOtpAndSubmit} className="space-y-4">
            <div className="text-center py-4">
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                Enter the 4-digit OTP sent to your new contact details.
              </p>
              <input
                type="text"
                maxLength="4"
                ...
                placeholder="0000"
                className="w-32 text-center bg-gray-50 dark:bg-gray-950 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-white p-4 rounded-xl text-2xl tracking-[0.5em] font-mono outline-none focus:border-orange-500 mx-auto"
                required
              />
            </div>
            <button
              type="submit"
              className="w-full bg-green-600 text-white font-bold py-3.5 rounded-xl shadow-md hover:bg-green-700 mt-2"
            >
  ...
  return (
    <>
      <div className="bg-white dark:bg-gray-900 p-5 md:p-8 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800 relative">
        <button
          onClick={startProfileUpdate}
          className="absolute top-6 right-6 text-orange-500 bg-orange-50 dark:bg-orange-500/10 px-3 py-1.5 rounded-lg text-[10px] font-bold uppercase hover:bg-orange-500 hover:text-white transition-all z-10"
        >
          ✏️ Update Info
        </button>
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 pb-6 border-b border-gray-100 dark:border-gray-800">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 bg-gray-200 dark:bg-gray-800 rounded-full flex items-center justify-center text-2xl border-2 border-orange-500/20">
              👤
            </div>
            <div>
              <h2 className="text-lg font-bold text-gray-900 dark:text-white">
              ...
              <div className="flex items-center gap-2 mt-1">
                <span
                  className={`px-2 py-0.5 rounded-full text-[9px] font-black uppercase tracking-wider ${riderDetails.isVerified ? "bg-green-100 text-green-700" : "bg-orange-100 text-orange-700"}`}
                >
        ...
        <div className="space-y-6">
          {/* Basic Info Group */}
          <div>
            <h3 className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-3 ml-1">
              Contact Details
            </h3>
          ...
          <div>
            <h3 className="text-[10px] font-black text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-3 ml-1 mt-8">
              Vehicles & Legal Documents
            </h3>
            <div className="bg-gray-50 dark:bg-gray-950 rounded-xl border border-gray-100 dark:border-gray-800 overflow-hidden flex flex-col divide-y divide-gray-100 dark:divide-gray-800">
              <div className="flex justify-between items-center p-4">
                <div>
                  ...
                  <p className="text-sm font-bold text-gray-900 dark:text-gray-200 uppercase">
                    {riderDetails.bikeNumber}
                  </p>
                </div>
                <button
                  onClick={() =>
                    openModal(riderDetails.bluebookDoc, "Bluebook / RC")
                  }
                  className="text-[10px] font-bold text-orange-600 bg-orange-100 dark:bg-orange-500/20 dark:text-orange-400 px-4 py-2 rounded-lg hover:bg-orange-200 transition"
                >
                  View Bluebook
                </button>
              </div>
              ...
              <div className="flex justify-between items-center p-4">
                ...
                <button
                  onClick={() =>
                    openModal(riderDetails.licenseFront, "Driving License")
                  }
                  className="text-[10px] font-bold text-orange-600 bg-orange-100 dark:bg-orange-500/20 dark:text-orange-400 px-4 py-2 rounded-lg hover:bg-orange-200 transition"
                >
                  View License
      ...
      {previewImage.isOpen && (
        ...
        >
          ...
          <button
            onClick={closeModal}
            className="app-close-btn absolute top-6 right-6 text-white bg-white/10 hover:bg-white/20 w-10 h-10 rounded-full hidden md:flex items-center justify-center transition-all z-50"
          >
            ✕
          </button>
