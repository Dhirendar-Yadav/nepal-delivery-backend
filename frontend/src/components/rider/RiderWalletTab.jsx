      ...
      <div className="space-y-4 relative">
        ...
        <div className="bg-gradient-to-br from-orange-500 to-orange-600 p-6 rounded-2xl shadow-lg text-white">
          ...
          <h2 className="text-3xl font-black">
            NPR {(walletBalance / 100).toFixed(2)}
          </h2>
          <p className="text-xs opacity-80 mt-2">
            This is the cash you collected from customers. Please deposit it to
            the company.
          </p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-800">
          ...
          <p className="text-xs text-gray-400 mt-1">
            Earnings feature will be live soon.
          </p>
        </div>

        {/* 🚀 UPGRADED: Premium Thin List Action Menu (Withdraw removed) */}
        <div className="mt-8 space-y-3">
          <h3 className="text-[10px] font-black text-gray-400 uppercase tracking-widest pl-2 mb-2">
            Wallet Details
          </h3>
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="text-left">
                ...
                <p className="text-[10px] font-medium text-gray-500 mt-0.5">
                  View real-time payouts & deposits
                </p>
              </div>
            </div>
            <span className="text-gray-300 dark:text-gray-600 font-bold pr-2 text-lg">
              ➔
            </span>
          </button>
        </div>
          ...
          <div className="bg-white dark:bg-gray-900 w-full max-w-md h-[75vh] md:h-auto md:max-h-[80vh] flex flex-col rounded-t-3xl md:rounded-3xl shadow-2xl border border-gray-200 dark:border-gray-800 animate-slide-up relative overflow-hidden">
            <div className="flex justify-between items-center p-6 border-b border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 z-10">
              ...
              <button
                ...
                className="app-close-btn w-8 h-8 bg-gray-100 dark:bg-gray-800 rounded-full text-gray-500 font-bold flex items-center justify-center hover:bg-gray-200 transition"
              >
                ✕
              </button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3 custom-scrollbar bg-gray-50 dark:bg-[#0a0a0a]">
              {isLoadingHistory ? (
                ...
                <div className="text-center py-10">
                  ...
                  <p className="text-xs text-gray-400 mt-1">
                    Your recent earnings and deposits will appear here.
                  </p>
                </div>
              ) : (
                historyData.map((tx, index) => (
                  <div
                    key={tx._id || index}
                    className="bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 p-4 rounded-xl flex justify-between items-center shadow-sm hover:shadow-md transition"
                  >
                    <div>
                    ...
                    <div className="text-right">
                      ...
                      <p
                        className={`text-lg font-black ${tx.transactionType === "debit" ? "text-red-500" : "text-green-500"}`}
                      >
                        {tx.transactionType === "debit" ? "-" : "+"} NPR{" "}
                        {tx.amount}
                      </p>
                      <p
