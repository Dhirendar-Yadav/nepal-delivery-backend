...
router.patch(
  "/restaurants/:id/operate",
  verifyAdmin,
  criticalLimiter,
  restaurantController.updateOperationalState,
);
router.patch(
  "/restaurants/:id/metrics",
  verifyAdmin,
  criticalLimiter,
  restaurantController.updateRankingMetrics,
);

router.post(
  "/sync-legacy-data",
  verifyAdmin,
  restaurantController.syncLegacyData,
);
