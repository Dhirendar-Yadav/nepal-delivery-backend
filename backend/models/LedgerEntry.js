...
const ledgerEntrySchema = new mongoose.Schema(
  {
    ...
    entityType: {
      type: String,
      enum: ["ADMIN", "RESTAURANT", "RIDER", "SYSTEM_CLEARING"],
      required: true,
    },
    ...
    amount: {
      ...
      validate: {
        ...
        message:
          "Amount must be stored as an integer (smallest currency unit).",
      },
    },
    ...
    balanceAfter: {
      ...
      validate: {
        ...
        message:
          "Balance must be stored as an integer (smallest currency unit).",
      },
    }, // 📊 Wallet Audit Trail
